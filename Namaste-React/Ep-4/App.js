  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://images.seeklogo.com/logo-png/44/1/shopify-logo-png_seeklogo-445424.png"
        />
      </div>
  ...
  return (
    <div className="body">
      ...
      <div className="rest-container">
        {/* <RestoCard proData={productList[0].products[0]}/>
        <RestoCard proData={productList[0].products[1]}/>
        <RestoCard proData={productList[0].products[2]}/> */}
